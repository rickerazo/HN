...
######################################### import function
#least number of spikes in a burst to be considered for analysis
min_spikes = 1
spike_lag_standard_deviation_adjusted = 1.0

def import_traces(gp, IpumpMax, tm, protocol, coupling):
    
    ##  converter minute to second
    t_ini = tm[0]*60
    t_end = tm[1]*60
    ...
    # interspike_tolerance = np.mean(spike_lag)+np.std(spike_lag)*0.0
    ...
    for i in range(0,np.size(first_spike)):
        ...
        # print(spike_times[first_spike[i]], spike_times[last_spike[i]], burst)
        # print(first_spike[i], last_spike[i])
    ...
    plt.savefig(fileID+'_Vm_IpumpMax='+str(IpumpMax)+'_gp='+str(gp)+'_protocol='+str(protocol)+'_coupling='+str(coupling)+'.png')

    ### duty cycle:
    duty_cycle = burst_duration[0:-1]/cycle_period

    # plt.figure(figsize=(20,10))
    # plt.plot(middle_spike[0:-1], duty_cycle)
    ######################################## PUMP CURRENT ######################################################################################
    ...
    #save the plot
    plt.savefig(fileID+'_Ipump_IpumpMax='+str(IpumpMax)+'_gp='+str(gp)+'_protocol='+str(protocol)+'_coupling='+str(coupling)+'.png')
    ...
    plt.xlabel('Time(s)')
    #save the plot
    plt.savefig(fileID+'_Na_in_IpumpMax='+str(IpumpMax)+'_gp='+str(gp)+'_protocol='+str(protocol)+'_coupling='+str(coupling)+'.png')


    ##########################################################################################################################################
    np.save(fileID+'_BD_IpumpMax='+str(IpumpMax)+'_gp='+str(gp)+'_protocol='+str(protocol)+'_coupling='+str(coupling),burst_duration)
    np.save(fileID+'_IBI_IpumpMax='+str(IpumpMax)+'_gp='+str(gp)+'_protocol='+str(protocol)+'_coupling='+str(coupling),interburst_interval)
    np.save(fileID+'_T_IpumpMax='+str(IpumpMax)+'_gp='+str(gp)+'_protocol='+str(protocol)+'_coupling='+str(coupling),cycle_period)
    np.save(fileID+'_Hz_IpumpMax='+str(IpumpMax)+'_gp='+str(gp)+'_protocol='+str(protocol)+'_coupling='+str(coupling),mean_Hz)

    np.save(fileID+'_DC_IpumpIpumpMax='+str(IpumpMax)+'_gp='+str(gp)+'_protocol='+str(protocol)+'_coupling='+str(coupling),duty_cycle)

    np.save(fileID+'_V_IpumpMax='+str(IpumpMax)+'_gp='+str(gp)+'_protocol='+str(protocol)+'_coupling='+str(coupling),V)
    np.save(fileID+'_time_IpumpMax='+str(IpumpMax)+'_gp='+str(gp)+'_protocol='+str(protocol)+'_coupling='+str(coupling),time)
    np.save(fileID+'_pump_IpumpMax='+str(IpumpMax)+'_gp='+str(gp)+'_protocol='+str(protocol)+'_coupling='+str(coupling),pump)
    np.save(fileID+'_cytNa_IpumpMax='+str(IpumpMax)+'_gp='+str(gp)+'_protocol='+str(protocol)+'_coupling='+str(coupling),cyt_na)
    np.save(fileID+'_Itot_IpumpMax='+str(IpumpMax)+'_gp='+str(gp)+'_protocol='+str(protocol)+'_coupling='+str(coupling),I_tot)
    np.save(fileID+'_interspikeTol_IpumpMax='+str(IpumpMax)+'_gp='+str(gp)+'_protocol='+str(protocol)+'_coupling='+str(coupling),interspike_tolerance)

    np.save(fileID+'_protocol_IpumpMax='+str(IpumpMax)+'_gp='+str(gp)+'_protocol='+str(protocol)+'_coupling='+str(coupling),protocol)
    np.save(fileID+'_coupling_IpumpMax='+str(IpumpMax)+'_gp='+str(gp)+'_protocol='+str(protocol)+'_coupling='+str(coupling),coupling)    
    #########################################################################################################################################
    # return fileID, burst_duration, interburst_interval, cycle_period, mean_Hz, duty_cycle, V, time, pump, cyt_na, I_tot, interspike_tolerance
    return fileID, spike_lag
...
# fileID, burst_duration, interburst_interval, cycle_period, mean_Hz, duty_cycle, V, time, pump, cyt_na, I_tot, interspike_tolerance = import_traces(gp, IpumpMax, tm , protocol, coupling)
fileID, spike_lag = import_traces(gp, IpumpMax, tm , protocol, coupling)
