...
riff2 = [1,2,3,4,5,6,7]#,8]
color_riff2 = [colores[1],colores[2], colores[3], colores[4], colores[5], colores[6], colores[7]]#, colores[8]]

riff3 =[4,5,7,8]#,9]#,9]
color_riff3= [colores[4],colores[5],colores[7],colores[8]]#,colores[9]]#,colores[9]]

riff4 = [4,5,6]
color_riff4 = [colores[4],colores[5],colores[6]]
...
for j in range(0,len(riff1)):
	p1 = float(riff1[j])*0.1
	p1 = format(format(p1,'.1f'))
	str1 = str(p1)
	plt.plot(0,0,'o',markersize=1e-3,color=color_riff1[j],label=r'I$_{pump}^{max}$= '+str1+' nA')
plt.axis([9,22,-65,15])
plt.title(r'G$_P$='+str(ctr_prm[0]))
...
plt.axis([9,37,-75,15])	
plt.title(r'G$_P$='+str(ctr_prm[1]))
plt.legend(loc=2,bbox_to_anchor=(-0.1,1.15),markerscale=1e+5,ncol=4,fontsize=100)
...
plt.axis([9,20,-75,15])
plt.title(r'G$_P$='+str(ctr_prm[2]))
plt.legend(loc=2,bbox_to_anchor=(-0.1,1.15),markerscale=1e+5,ncol=4,fontsize=100)
...
for c1 in range(3,6):
	...
	plt.axis([9,20,-75,15])
	plt.title(r'I$_{pump}^{max}$='+str(ctr_prm[c1]))
	plt.legend(loc=2,bbox_to_anchor=(-0.1,1.15),markerscale=1e+5,ncol=4,fontsize=100)
